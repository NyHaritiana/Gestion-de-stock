...
function Login() {
  ...
  return (
    <>
      ...
      >
        <div className="flex w-screen max-w-xl rounded-lg shadow-lg overflow-hidden">
          <div className="flex justify-center items-center"  style={{ backgroundColor: '#FFFF00' }}>
            <img src={logoMFA} alt="mfa" className="opacity-20" />
          </div>
